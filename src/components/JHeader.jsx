...
const JHeader = ({call, floatting}) => {
    ...
    const backgrounds = [
        "./src/assets/img/633288.png",
        "./src/assets/img/633294.png",
        "./src/assets/img/796108.jpg",
        "./src/assets/img/909641.png"
    ]
    //Random Background
    ...
    const randonLocation = ()=>{
        return Math.round(Math.random()*(location_names.length-1))+1
    }
